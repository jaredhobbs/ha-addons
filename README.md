# Jared's Home Assistant add-on repository
...
### [amridm2mqtt add-on](./amridm2mqtt)
...
### [eufy-ha-mqtt-bridge add-on](./eufy-ha-mqtt-bridge)
...
_Subscribes to push notifications of the Eufy Security app and publishes events via MQTT to Home Assistant_

### [selenium-standalone-chrome add-on](./selenium-standalone-chrome)
...
_Provides a Selenium Grid Standalone with Chrome (or Chromium), which enables you to run Selenium WebDriver remotely._
